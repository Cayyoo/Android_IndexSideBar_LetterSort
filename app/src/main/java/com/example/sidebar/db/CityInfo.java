...
public class CityInfo {
	...
	public CityInfo(String province, String city, String number, String firstPY, String allPY, String allFirstPY) {
	...
	public String toString() {
		return "CityInfo [province=" + province + ", city=" + city + ", number="
